  ...
  const projects = [
    {
      ...
      video: "/videos/WingsOfFreedom.mp4",
    ...
    },
    {
      ...
      video: "/videos/HarmonyOfNature.mp4",
    ...
    },
    {
      ...
      video: "/videos/FlightBeyondBoundries.mp4",
        ...
        >
          ...
          <div className="absolute top-0 right-0 w-72 xl:w-80 z-10">
            ...
            <p className="text-sm leading-relaxed text-gray-600">
              Celebrating timeless stories of birds that inspire freedom,
              harmony, and connection across skies, forests, and beyond.
            </p>
          </div>
